...
@keyframes slider {     
 ...
 <body>
<div id="container">
 	<header style="background-color: #484848; color: white; padding: 20px; font-family: cursive; box-shadow: 2px 2px 2px rgba(0,0,0,0.8);">Sistem Informasi
 	</header>
 	<br>
 	<br>
 	...
 	<br>
 	<br>
 	<p style="font-family: cursive; background-color: #484848; color: white; padding: 20px; box-shadow: 2px 2px 2px rgba(0,0,0,0.8);">Bakti Sosial</p>
